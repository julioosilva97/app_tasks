...
class TaskFormActivity : AppCompatActivity(), View.OnClickListener,
    ...
    private fun handleSave() {
        val task = TaskModel().apply {
            ...
            this.priorityId =
                mListPriorityId[spinner_priority.selectedItemPosition] //meio sem sentido,pega a posição do sppiner
        }
    ...
    private fun showDatePicker() {
        val c = Calendar.getInstance() // pega horario do celular
    ...
    private fun observe() {
        ...
        mViewModel.priorities.observe(this, androidx.lifecycle.Observer {
            ...
            val adpter = ArrayAdapter(this, android.R.layout.simple_spinner_dropdown_item, list)
            spinner_priority.adapter = adpter
        })
